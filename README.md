...
A GitHub template repository for Umbraco 17 with the Clean Starter Kit, preconfigured for [GreenStack](https://umbhost.net/sustainable-cloud-hosting/modern-umbraco-hosting) hosting.
